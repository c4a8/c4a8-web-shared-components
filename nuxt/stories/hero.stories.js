...
export const TextImage = {
  args: {
    hero: {
      ...
      shape: {
        img: '/assets/svg/shapes/shape-career.svg',
        alt: 'Shape',
        bottom: true,
      },
    },
...
export const Small = {
  args: {
    hero: {
      ...
      light: true,
      shape: {
        img: '/assets/svg/shapes/event-confirmation-message.svg',
        top: true,
        alt: 'Success Message',
      },
    },
...
export const ShapeInContent = {
  args: {
    hero: {
      ...
      shape: {
        alt: 'Shape',
        img: '/assets/svg/shapes/shape-security-eye.svg',
        inContent: true,
      },
    },
  },
...
export const ShapeInContentMobile = {
  args: {
    hero: {
      ...
      shape: {
        alt: 'Shape',
        img: '/assets/svg/shapes/shape-hero-zencat.svg',
