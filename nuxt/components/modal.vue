            ...
            <div class="modal__error-row row">
              <div class="modal__error-content col-lg-8">
                ...
                <div class="modal__error-mail">
                  ...
                  <a class="custom" :href="'mailto:' + modalErrorValue.mail">{{ modalErrorValue.mail }} </a>
                </div>
                <div class="modal__error-phone">
                  <icon icon="phone" size="small" />
                  <a class="custom" :href="'tel:' + modalErrorValue.phone"> {{ modalErrorValue.phone }} </a>
                </div>
