...
.video-slider .video-slider__row {
  width: 100%;
}
...
.video-slider .slick-slide .video__content {
  opacity: 0;
  transition: opacity 0.3s ease-in-out;
}
.video-slider .slick-center .video__content {
  opacity: 1;
}
...
.video-slider__footer .cta__text {
  font-size: 1.25rem;
  line-height: 2.5rem;
}
