  ...
  computed: {
    classList() {
      return [
        ...
        this.overflow || this.hasControls ? 'slider--overflow' : '',
        'vue-component',
      ];
    },
    jsonOptions() {
