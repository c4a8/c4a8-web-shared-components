...
<style>
@keyframes fade-out{to{transform:translateX(100vw) translateY(-100vh)}}@keyframes fade-in{0%{margin-left:-50%}to{opacity:1}}@media (prefers-reduced-motion:no-preference){.fade-in-animation{animation:fade-in 4s 1 forwards}.fade-out-animation{animation:fade-out 8s 1 forwards}}
</style>
<script>
...
export default {
  ...
  methods: {
    ...
    setHeight() {
      this.heightFixed = getComputedStyle(this.$refs.modalContent).height;
    },
  },
};
</script>
