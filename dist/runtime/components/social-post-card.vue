...
.social-post-card .icon.social-post-card__stat-icon {
  width: 1.15rem;
  height: 1.15rem;
}
...
.social-post-card__avatar {
  flex-shrink: 0;
  width: 1.5rem;
  height: 1.5rem;
}
.social-post-card__avatar img {
  width: 100%;
  height: 100%;
  object-fit: cover;
}

.social-post-card__repost-avatar {
  width: 1.25rem;
  height: 1.25rem;
  display: flex;
}

.social-post-card__repost {
  border-radius: 5px;
  border: 1px solid var(--social-post-card-border-color);
  margin-top: 1rem;
}
.social-post-card__repost .social-post-card__content {
  padding: 1rem;
}

.social-post-card__repost-header {
  padding: 1rem 1rem 0;
}
...
.social-post-card__author-handle-time,
.social-post-card__meta,
.social-post-card__linkedin-badge {
  color: var(--color-copy-reduced);
}

.social-post-card__linkedin-icon {
  font-size: 1.1rem;
  line-height: 1;
}
...
.social-post-card__content :where(p) {
  margin-bottom: 0.5rem;
}
.social-post-card__content :where(p:last-child) {
  margin-bottom: 0;
}

.social-post-card__read-more {
  color: var(--color-copy-reduced);
...
.social-post-card__media,
.social-post-card__repost-media {
  cursor: pointer;
  position: relative;
  overflow: hidden;
}
.social-post-card__media img,
.social-post-card__repost-media img {
  width: 100%;
  height: auto;
  display: block;
  transition: transform 1.5s cubic-bezier(0.19, 1, 0.2, 1);
}
