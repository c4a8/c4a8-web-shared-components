<template>
  <div :class="['tag-cloud', { 'is-sticky-scroller': sticky }]">
    ...
    <div class="tag-cloud__container container-lg">
...
<script>
import BaseComponent from '../utils/components/base-component.js';
import Animate from '../utils/animate.js';
import Tools from '../utils/tools.js';
import Events from '../utils/events.js';

// --- TagCloud class as you provided ---
...
export default {
  ...
  mounted() {
    // Wait for DOM to render, then instantiate TagCloud
    this.$nextTick(() => {
      this._tagCloudInstance = new TagCloud(this.$el, {});
    });
  },
  beforeUnmount() {
    // Clean up scroll animation if needed
    if (this._tagCloudInstance && typeof this._tagCloudInstance.stopScrollAnimation === 'function') {
      this._tagCloudInstance.stopScrollAnimation();
    }
    this._tagCloudInstance = null;
  },
};
</script>