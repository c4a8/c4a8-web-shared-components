<template>
    <div class="grid has-background utility-animation vue-component" :style="style" ref="root">
            ...
            <div class="grid__row row">
                <div class="grid__col col">
                    ...
                    <div class="grid__items">
                        <div class="grid__item fade-in-bottom" v-for="(item, index) in items" :key="index"
                            :style="getItemStyle(index)" data-utility-animation-step="1">
                            <span class="grid__item-title" v-if="item.title">{{ item.title }}</span>
                            <v-img class="grid__item-img" :img="item.img" :alt="item.alt" v-if="item.img"
