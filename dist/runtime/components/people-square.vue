  ...
  <div :class="['people-square', { 'people-square--absolute': absolute }]">
    ...
    >
      ...
      >
        ...
        <template v-else> 
          <div
            class="people-square__background"
            :style="element.color ? { backgroundColor: element.color } : null"
          >
            <img
              v-if="element.shape"
              :src="element.shape.src"
          ...
          <div class="people-square__content">
            <div
              v-if="element.number"
              class="people-square__number"
              :data-animate-number="{ start: 0, end: element.number }"
            >
              {{ element.number }}
            </div>
