<template>
  <div :class="classList" data-utility-animation-step="1" :style="style">
    <div class="bg-white d-flex flex-column h-100 py-5 px-3">
      ...
      <ul v-if="secondList" class="dashed m-0 flex-grow-1">
        <li
          v-for="(text, textIndex) in secondList"
          class="feature-grid-item__text font-size-sm"
          v-html="text"
          v-bind:key="textIndex"
        ></li>
...
ul.dashed li.feature-grid-item__text::before,
.feature-grid-item__text::before {
  content: "";
  width: 15px;
  height: 2px;
