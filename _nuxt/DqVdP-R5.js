import{_ as W}from"./BvNBs35S.js";import{_ as C}from"./BvOkbsjE.js";import{_ as I}from"./CpmK0_Tr.js";import{S as L}from"./C0jt2fdE.js";import{U as j}from"./FECscspt.js";import{_ as N,c as i,b as o,a as u,d as a,F as V,r as J,f as v,n as t,o as s}from"./CV0-TAqy.js";import"./BtKxkMcr.js";const B={tagName:"icon-blocks",props:{iconBlocks:{type:Object,required:!0},level:{type:String,default:"h3"},classes:{type:String,default:"font-size-3 bold"},columns:{type:[Boolean,Number],default:!1},headline:{type:String,default:null},sticky:{type:Boolean,default:!1},spacing:{type:String,default:""}},computed:{columnClass(){if(this.columns){const m=12/this.columns,e=`col-md-${m}`;return m%2===0?`col-6 ${e}`:e}return"col-md-4"}},mounted(){this.sticky&&L.init([this.$el]),j.init([this.$el])}},R={class:"container space-2"},H={key:0,class:"row mt-5 mb-8 px-lg-3 fade-in-bottom","data-utility-animation-step":"1"},F={class:"col"},q={class:"row"},U=["innerHTML"],G={key:1,class:"row justify-content-center mt-8"};function K(d,m,e,S,X,z){const p=W,x=C,T=I;return s(),i("div",{class:t(["icon-blocks","utility-animation",e.spacing,"container-fluid",{"is-sticky-scroller":e.sticky}]),style:v({backgroundColor:e.iconBlocks.bgColor})},[o("div",R,[e.headline?(s(),i("div",H,[o("div",F,[a(p,{text:e.headline,level:"h3"},null,8,["text"])])])):u("",!0),o("div",q,[(s(!0),i(V,null,J(e.iconBlocks.items,(n,f)=>(s(),i("div",{key:f,class:t([z.columnClass,"mb-5","mb-md-8","fade-in-bottom"]),"data-utility-animation-step":"1",style:v({"--utility-animation-index":f+1})},[o("div",{class:t(["px-lg-3",{"text-center":!n.copy}])},[o("figure",{class:t(["max-w-15rem","mb-4",{"mx-auto":!n.copy}])},[a(x,{img:n.image,cloudinary:n.cloudinary,alt:e.iconBlocks.alt},null,8,["img","cloudinary","alt"])],2),a(p,{text:n.headline,level:e.level,classes:e.classes},null,8,["text","level","classes"]),o("div",{innerHTML:n.copy},null,8,U)],2)],6))),128))]),e.iconBlocks.cta?(s(),i("div",G,[a(T,{text:e.iconBlocks.cta.text,href:e.iconBlocks.cta.href,skin:e.iconBlocks.cta.skin,button:e.iconBlocks.cta.button},null,8,["text","href","skin","button"])])):u("",!0)])],6)}const Q=N(B,[["render",K]]);B.__docgenInfo={exportName:"default",displayName:"icon-blocks",description:"",tags:{},props:[{name:"iconBlocks",type:{name:"object"},required:!0},{name:"level",type:{name:"string"},defaultValue:{func:!1,value:"'h3'"}},{name:"classes",type:{name:"string"},defaultValue:{func:!1,value:"'font-size-3 bold'"}},{name:"columns",type:{name:"boolean|number"},defaultValue:{func:!1,value:"false"}},{name:"headline",type:{name:"string"},defaultValue:{func:!1,value:"null"}},{name:"sticky",type:{name:"boolean"},defaultValue:{func:!1,value:"false"}},{name:"spacing",type:{name:"string"},defaultValue:{func:!1,value:"''"}}],sourceFiles:["/home/runner/work/c4a8-web-shared-components/c4a8-web-shared-components/nuxt-storybook-test/components/icon-blocks.vue"]};const se={title:"Components/Icon Blocks",component:Q,decorators:[d=>({components:{story:d},template:`
        <div>
          <story />
...
}`,...(k=(h=r.parameters)==null?void 0:h.docs)==null?void 0:k.source}}};var A,w,b;c.parameters={...c.parameters,docs:{...(A=c.parameters)==null?void 0:A.docs,source:{originalSource:`{
  args: {
    columns: 4,
...
}`,...(b=(w=c.parameters)==null?void 0:w.docs)==null?void 0:b.source}}};var _,D,E;l.parameters={...l.parameters,docs:{...(_=l.parameters)==null?void 0:_.docs,source:{originalSource:`{
  args: {
    columns: 4,
