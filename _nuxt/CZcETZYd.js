import{_ as N}from"./NVa8QgPl.js";import{_ as L}from"./CwNkEa2G.js";import{_ as D,c as a,o as i,d as w,f as y,T as m,b as n,a as g,n as p,t as x,F as A,r as R,e as k}from"./BfI018_m.js";import{_ as U}from"./BqudqSBe.js";import{_ as H}from"./DUd0TBHp.js";import{U as O}from"./CRgvQN4C.js";import{g as h}from"./esXqDRs6.js";import"./BqGAW6nR.js";const T={tagName:"img-filter",props:{img:String,alt:String,cloudinary:{default:null},lazy:Boolean,classes:String,color:String},computed:{cloudinaryValue(){return m.isTrue(this.cloudinary)},colorValue(){return this.color?this.color:"#000520"},svgFilter(){const s=parseFloat((m.red(this.colorValue)/255).toFixed(5)),l=parseFloat((m.green(this.colorValue)/255).toFixed(5)),e=parseFloat((m.blue(this.colorValue)/255).toFixed(5)),c=1,b=Math.max(s,l,e),o=Math.min(s,l,e),r=100*(b+o)/2+"%",u="img-to-color";return`
