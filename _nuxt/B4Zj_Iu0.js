import{_ as N}from"./Bmyn1a5l.js";import{_ as L}from"./0OFer8t3.js";import{_ as D,c as a,o as i,d as w,f as y,T as m,b as n,a as g,n as p,t as x,F as A,r as R,e as k}from"./3KJPBjVZ.js";import{_ as U}from"./A88hxRXS.js";import{_ as H}from"./TDLbb105.js";import{U as O}from"./D6EH5ojK.js";import{g as h}from"./esXqDRs6.js";import"./DBHRzw-f.js";const T={tagName:"img-filter",props:{img:String,alt:String,cloudinary:{default:null},lazy:Boolean,classes:String,color:String},computed:{cloudinaryValue(){return m.isTrue(this.cloudinary)},colorValue(){return this.color?this.color:"#000520"},svgFilter(){const s=parseFloat((m.red(this.colorValue)/255).toFixed(5)),l=parseFloat((m.green(this.colorValue)/255).toFixed(5)),e=parseFloat((m.blue(this.colorValue)/255).toFixed(5)),c=1,b=Math.max(s,l,e),o=Math.min(s,l,e),r=100*(b+o)/2+"%",u="img-to-color";return`
