import{_ as H}from"./BptSGa4z.js";import{_ as D}from"./D7ZFgwSf.js";import{_ as I,c as l,o as i,d as w,f as v,T as g,b as t,a as m,n as h,t as x,F as S,r as O,e as k}from"./G6QyU7Ck.js";import{_ as j}from"./DjB2HKTr.js";import{_ as $}from"./BgTlVF7m.js";import{U as q}from"./C7RBnFis.js";import"./DJ3qKat7.js";const M={tagName:"img-filter",props:{img:String,alt:String,cloudinary:{default:null},lazy:Boolean,classes:String,color:String},computed:{cloudinaryValue(){return g.isTrue(this.cloudinary)},colorValue(){return this.color?this.color:"#000520"},svgFilter(){const s=parseFloat((g.red(this.colorValue)/255).toFixed(5)),o=parseFloat((g.green(this.colorValue)/255).toFixed(5)),e=parseFloat((g.blue(this.colorValue)/255).toFixed(5)),c=1,y=Math.max(s,o,e),r=Math.min(s,o,e),a=100*(y+r)/2+"%",d="img-to-color";return`
