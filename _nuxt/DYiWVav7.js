import{_ as G}from"./Dlmo-TKZ.js";import{_ as E}from"./BpztMl_M.js";import{_ as L,c as a,o as i,d as k,f as v,T as m,b as n,a as g,n as p,t as b,F as w,r as N,e as x}from"./DtdzaNpP.js";import{_ as R}from"./CLsAdSoR.js";import{_ as U}from"./nmk8Qfx-.js";import{U as H}from"./B9A3WaxN.js";import"./CY3T7eBr.js";const D={tagName:"img-filter",props:{img:String,alt:String,cloudinary:{default:null},lazy:Boolean,classes:String,color:String},computed:{cloudinaryValue(){return m.isTrue(this.cloudinary)},colorValue(){return this.color?this.color:"#000520"},svgFilter(){const s=parseFloat((m.red(this.colorValue)/255).toFixed(5)),l=parseFloat((m.green(this.colorValue)/255).toFixed(5)),e=parseFloat((m.blue(this.colorValue)/255).toFixed(5)),c=1,y=Math.max(s,l,e),o=Math.min(s,l,e),r=100*(y+o)/2+"%",u="img-to-color";return`
